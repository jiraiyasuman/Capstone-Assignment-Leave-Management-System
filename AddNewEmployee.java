...
public AddNewEmployee(String name, String gender, String email, String phNumber, String role, String id,
		String reporting, String reportingName, String reportingEmail) {
	super();
	this.name = name;
	this.gender = gender;
	this.email = email;
