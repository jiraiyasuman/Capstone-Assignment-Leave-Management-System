...
import com.AxisBank.LeaveManagementSystem.databaseConnection.Emails;
...
import com.AxisBank.LeaveManagementSystem.service.LeaveBalance;
import com.AxisBank.LeaveManagementSystem.util.ManageManagerDaoRepoUtil;
	            	...
	            	if(balance>0)
	            	{
	            		if(ab<=15){
	            			...
	            			if(f==true)
	            			{
	            				...
	            				resp.sendRedirect("view/myLeaveSeniorManager.jsp");
	            			}
	            			else
	            			{
