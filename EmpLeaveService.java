...
import com.AxisBank.LeaveManagementSystem.entity.ApplyLeaveEmployee;

public class EmpLeaveService implements EmpLeaveDaoRepo {
public static Connection conn=null;
public static ApplyLeaveEmployee a=null;
public EmpLeaveService(Connection conn)
{
	this.conn=conn;
}
public boolean insert(ApplyLeaveEmployee ah)
{
	boolean f=false;
	try {
		Connection conn=DbConnect.getConnection();
		String sql="INSERT INTO leavemanagementsystem.finalleaverecordemployees (EMPLOYEE_ID, NAME, FROM_DATE, TO_DATE,LEAVE_TYPE,NO_OF_DAYS, LEAVE_REASON,LEAVE_BALANCE,STATUS,REPORTING_EMAIL) VALUES (?, ?, ?, ?, ?, ?,?, ?,?,?);";
