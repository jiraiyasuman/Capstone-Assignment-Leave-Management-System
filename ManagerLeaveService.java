...
public class ManagerLeaveService implements ManagerLeaveDaoRepo{
Connection conn=null;
ApplyLeaveManager a=null;
public ManagerLeaveService(Connection conn)
{
	this.conn=conn;
}
public boolean insert(ApplyLeaveManager ah)throws Exception
{
	...
	try {
		...
		String sql="INSERT INTO `leavemanagementsystem`.`finalleaverecordmanager` (`EMPLOYEE_ID`, `NAME`, `FROM_DATE`, `TO_DATE`, `LEAVE_TYPE`, `NO_OF_DAYS`, `LEAVE_REASON`, `LEAVE_BALANCE`, `STATUS`, `REPORTING_EMAIL`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
